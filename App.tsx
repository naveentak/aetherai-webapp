      ...
      <nav className="fixed top-0 left-0 right-0 z-40 border-b border-white/5 bg-black/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono text-neutral-500 uppercase tracking-wider hidden sm:block">| Aether AI</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-neutral-400">
            <a href="#curriculum" className="hover:text-white transition-colors">Sessions</a>
            <a href="#audience" className="hover:text-white transition-colors">Who It's For</a>
            <a href="#features" className="hover:text-white transition-colors">Why This Course</a>
          </div>
      ...
      <main>
        ...
        <section className="py-32 px-6 text-center border-t border-white/5">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-sm text-neutral-600 font-mono">
